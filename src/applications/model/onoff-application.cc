...
// Private helpers
    ...
    void
    OnOffApplication::ScheduleStartEvent() {  // Schedules the event to start sending data (switch to the "On" state)
        NS_LOG_FUNCTION(this);
    ...
    void OnOffApplication::ScheduleStopEvent() {  // Schedules the event to stop sending data (switch to "Off" state)
        NS_LOG_FUNCTION(this);
    ...
    uint64_t OnOffApplication::GetTotalSent() {
        return m_totBytes;
    }

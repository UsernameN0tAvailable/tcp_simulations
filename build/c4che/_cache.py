...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1553721932202/work=/usr/local/src/conda/python-3.7.3', '-fdebug-prefix-map=/home/mattia/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
EXAMPLE_DIRECTORIES = ['routing', 'stats', 'socket', 'tutorial', 'wireless', 'realtime', 'ipv6', 'traffic-control', 'error-model', 'energy', 'udp-client-server', 'tcp', 'naming', 'udp', 'matrix-topology']
...
INCLUDES_PYEMBED = ['/home/mattia/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/mattia/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/home/mattia/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_EXECUTABLE_PATH = ['/home/mattia/tcp/build/src/fd-net-device', '/home/mattia/tcp/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/mattia/tcp/build/lib']
...
cfg_files = ['/home/mattia/tcp/build/ns3/config-store-config.h', '/home/mattia/tcp/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
